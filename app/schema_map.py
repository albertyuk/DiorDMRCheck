...
# ------------------------------------------------------------------- schema
# (canonical header text, normalized key, required, description shown to the
# model AND to the human auditor). The canonical text must round-trip through
# header_key() to the key — tests enforce this.
